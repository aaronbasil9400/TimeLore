...
Breadcrumb is an iOS reminder app built around one differentiator: a reminder should preserve not only **what** to do, but **why** it matters.

The repository currently contains product discovery material and an Xcode-first implementation plan. It does not yet contain an Xcode project.
...
- [Original app concept](Breadcrumb%20App%20Concept.md) — long-term vision, not current scope.
